<%@ Page Title="" Language="C#" MasterPageFile="~/Afterlogin.master" AutoEventWireup="true" CodeFile="feedback.aspx.cs" Inherits="feedback" %>
    ...
    <div class="container-fluid bg "> 
        <div class="row">
            <div class="col-md-4 col-ms-4 col-xs-12" >
                 <img src="Image/feedback1.png" class="rounded float-left img" alt="..." height="300" width="300"/>
            </div>
            <div class="col-md-4 col-ms-4 col-xs-12 body" >
             ...
             <div class="col-md-4 col-ms-4 col-xs-12">
                <img src="Image/feedback.png" class="rounded float-right img" alt="..." height="300" width="300">
            </div>
        </div>

...
public partial class Admin_SearchComplaint : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "select *from Registercomplaint where Complaintid=@t1";//SQL Query
            ...
            {
                Label1.Visible = true;
                Label1.Text = "Complaint Id not found";
            }
        }

<%@ Page Title="" Language="C#" MasterPageFile="~/Beforelogin.master" AutoEventWireup="true" CodeFile="studentlogin.aspx.cs" Inherits="studentlogin" %>
    ...
    <div class="container-fluid bg"> 
        <div class="row">
            ...
            <div class="col-md-4 col-ms-4 col-xs-12 box" >
                <form >
                    <h3 class="text-center text-capitalize " >Student LogIn</h3>
                 ...
                 <div class="form-group">
                     <asp:LinkButton ID="LinkButton1" runat="server" PostBackUrl="~/Registration.aspx">Create New User Account</asp:LinkButton>
                 </div>
                </form>
            </div>
            <div class="col-md-4 col-ms-4 col-xs-12" ></div>

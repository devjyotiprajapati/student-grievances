...
public partial class Facultylogin : System.Web.UI.Page
{
    ...
    protected void bt1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "select * from Faculty where Username=@12 and password=@21";//SQL Query
            ...
            {
                Session["usr2"] = TextBox1.Text;//Globle variable Session for calling any where in project
                Response.Redirect("AllReply.aspx");//Open Home Page
            }
            else//If Unmatched
            {
                Label1.Visible = true;
